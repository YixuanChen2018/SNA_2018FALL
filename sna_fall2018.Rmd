...
#由以上分析结果可知，该网络中只存在一个组件，即一个团体。所有与会者都连接在一个组;网络中没有孤立的参与者。位于周边区域的学生与其他参与者有一定程度的互动（见网络图）。
...
#由此可知，教师T1的出入度总和最高，中心度值最大，交互次数最多，这说明教师T1积极参与了讨论，也可能因为大多数学生欣赏和感谢其在线课程设计和辅导。
